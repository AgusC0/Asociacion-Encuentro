...
<head>
	...
	<title>Ricardo Alfonso | Localidad</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Nombre de Localidad</label>
<div class="controls">
<input type="text" placeholder="Ingresar nombre de Localidad"  name="subcategory" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
                                            ...
                                            <a href="edit-subcategory.php?id=<?php echo $row['id']?>" ><i class="icon-edit"></i></a>
                                              <a href="imprimir-localidad.php?scid=<?php echo $row['id']?>" ><i title="Imprimir listado PUBLICO" class="icon-print"></i></a>
                                                <a href="imprimir-localidad-interno.php?scid=<?php echo $row['id']?>" ><i title="Imprimir listado INTERNO" class="icon-print"></i></a>
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Estas seguro que quieres eliminar?')"><i class="icon-remove-sign"></i></a></td>
