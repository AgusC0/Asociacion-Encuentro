...
$sourceFoto      = $_FILES['productimage3']['tmp_name'];
...
$imagenCliente = $dirLocal.'/'.$nuevoNameFoto;
	...
	$sql=mysql_query("update noticias set productImage3='$nuevoNameFoto' where id='$pid' ");
    $_SESSION['msg']="Imagen 3 actualizada exitosamente!!";
...
$query=mysql_query("select tituloNoticia,productImage3,id from noticias where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen actual 3</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage3']);?>" width="200" height="100"> 
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen nueva 3</label>
<div class="controls">
