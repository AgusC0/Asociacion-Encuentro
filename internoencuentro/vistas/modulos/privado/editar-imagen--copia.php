...
{
	$productname=$_POST['idEntrada'];
	$productimage1=$_FILES["productimage1"]["name"];
$ret=mysql_query("select productImage1 from imagenes where categoryName='$pid'");
...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysql_query("update  imagenes set productImage1='$productimage1' where id='$pib' ");
$_SESSION['msg']="Imagen actualizada exitosamente!!";
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar imagen de propiedad</h3>
							</div>
...
$pid=intval($_GET['pid']);
$pib=intval($_GET['pib']);
$ret=mysql_query("select * from imagenes where categoryName = $pid and id = $pib  ");
...
<label class="control-label" for="basicinput">Nº de propiedad</label>
<div class="controls">
<input type="text"    name="idEntrada"  readonly value="<?php echo htmlentities($row['categoryName']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['categoryName']);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> 
</div>
</div>
