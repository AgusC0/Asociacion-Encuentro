...
{
$filename        = $_FILES['productimage6']['name'];
$sourceFoto      = $_FILES['productimage6']['tmp_name'];
...
$sql=mysql_query("update noticias set productImage6='$nuevoNameFoto' where id='$pid' ");
$_SESSION['msg']="Imagen 6 actualizada exitosamente!!";
}
?>
<!DOCTYPE html>
<html lang="es">
...
$query=mysql_query("select tituloNoticia,productImage6,id from noticias where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen actual 6</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage6']);?>" width="200" height="100"> 
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen nueva 6</label>
<div class="controls">
<input type="file" name="productimage6" id="productimage6" value="" class="span8 tip" required>
</div>
</div>
