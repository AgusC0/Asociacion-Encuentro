...
$sourceFoto      = $_FILES['productimage2']['tmp_name'];
...
$imagenCliente = $dirLocal.'/'.$nuevoNameFoto;
	...
	$sql=mysql_query("update noticias set productImage2='$nuevoNameFoto' where id='$pid' ");
    $_SESSION['msg']="Imagen 2 actualizada exitosamente!!";
...
$query=mysql_query("select tituloNoticia,productImage2,id from noticias where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen actual 2</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> 
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen nueva 2</label>
<div class="controls">
