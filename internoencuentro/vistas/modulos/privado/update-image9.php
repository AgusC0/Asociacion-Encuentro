...
{
$filename        = $_FILES['productimage9']['name'];
$sourceFoto      = $_FILES['productimage9']['tmp_name'];
...
$sql=mysql_query("update noticias set productImage9='$nuevoNameFoto' where id='$pid' ");
$_SESSION['msg']="Imagen 9 actualizada exitosamente!!";
}
?>
<!DOCTYPE html>
<html lang="es">
...
$query=mysql_query("select tituloNoticia,productImage9,id from noticias where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen actual 9</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage9']);?>" width="200" height="100"> 
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen nueva 9</label>
<div class="controls">
<input type="file" name="productimage9" id="productimage9" value="" class="span8 tip" required>
</div>
</div>
