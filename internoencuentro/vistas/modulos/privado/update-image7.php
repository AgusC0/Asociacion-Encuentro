...
{
$filename        = $_FILES['productimage7']['name'];
$sourceFoto      = $_FILES['productimage7']['tmp_name'];
...
$sql=mysql_query("update noticias set productImage7='$nuevoNameFoto' where id='$pid' ");
$_SESSION['msg']="Imagen 7 actualizada exitosamente!!";
}
?>
<!DOCTYPE html>
<html lang="es">
...
$query=mysql_query("select tituloNoticia,productImage7,id from noticias where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen actual 7</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage7']);?>" width="200" height="100"> 
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen nueva 7</label>
<div class="controls">
<input type="file" name="productimage7" id="productimage7" value="" class="span8 tip" required>
</div>
</div>
