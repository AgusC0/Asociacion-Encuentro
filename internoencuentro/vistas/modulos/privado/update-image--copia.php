...
<label class="control-label" for="basicinput">Nombre propiedad</label>
<div class="controls">
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['']);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> 
</div>
</div>
