...
<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
	<link rel="stylesheet" href="../admin/beneficios/responsive.css">
	<link rel="stylesheet" href="../admin/beneficios/fonts.css">
...
<body> <p><a style="text-align:left;" href="javascript:imprSelec('imp')"  class="btn btn-success pull-left"><span class="glyphicon glyphicon-print"></span>Imprimir</a></p><p style="text-align:right;"><a  href="subcategory.php"class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span>Volver</a></p>
<br><br>
<div id="imp">
...
<h2 align="center" style="font-family:Arial, Helvetica, sans-serif;"><font color="#000000">Listado de <?php $sql=mysql_query("select subcategory  from subcategory where id='$cid'");
