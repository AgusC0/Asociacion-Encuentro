...
<head>
	...
	<title><?php include('include/titulo.php');?>  | Categoria</title>
...
?>									
										<tr>
											...
											<a href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Estas seguro que queres eliminar?')"><i class="icon-remove-sign"></i></a></td>
