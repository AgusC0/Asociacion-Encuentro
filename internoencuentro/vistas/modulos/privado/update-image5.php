...
{
$filename        = $_FILES['productimage5']['name'];
$sourceFoto      = $_FILES['productimage5']['tmp_name'];
...
$sql=mysql_query("update noticias set productImage5='$nuevoNameFoto' where id='$pid' ");
$_SESSION['msg']="Imagen 5 actualizada exitosamente!!";
}
?>
<!DOCTYPE html>
<html lang="es">
...
$query=mysql_query("select tituloNoticia,productImage5,id from noticias where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen actual 5</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage5']);?>" width="200" height="100"> 
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen nueva 5</label>
<div class="controls">
<input type="file" name="productimage5" id="productimage5" value="" class="span8 tip" required>
</div>
</div>
