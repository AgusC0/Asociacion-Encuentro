...
<head>
	...
	<title><?php include('include/titulo.php');?>  | Editar Categoria</title>
...
<div class="controls">
<input type="text" placeholder="Ingresar nombre de categoría"  name="category" value="<?php echo  htmlentities($row['categoryName']);?>" class="span8 tip" required>
</div>
</div>
