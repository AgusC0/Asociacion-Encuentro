...
<head>
	...
	<title>Ricardo Alfonso | Editar SubCategoría</title>
...
<div class="controls">
<input type="text" placeholder="Ingresar nombre de localidad"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
