...
{
$filename        = $_FILES['productimage4']['name'];
$sourceFoto      = $_FILES['productimage4']['tmp_name'];
...
$imagenCliente = $dirLocal.'/'.$nuevoNameFoto;
	...
	$sql=mysql_query("update noticias set productImage4='$nuevoNameFoto' where id='$pid' ");
    $_SESSION['msg']="Imagen 4 actualizada exitosamente!!";
...
$query=mysql_query("select tituloNoticia,productImage4,id from noticias where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen actual 4</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage4']);?>" width="200" height="100"> 
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen nueva 4</label>
<div class="controls">
