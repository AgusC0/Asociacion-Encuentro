...
<h2 align="center" style="font-family:Arial, Helvetica, sans-serif;"><font color="#000000">LISTADO INTERNO DE PROPIEDADES CARGADAS</font></h2>
<br>
<?php 
...
<p><strong>Nº de propiedad:</strong> SOL- <?php echo htmlentities($row['id']);?>  </p>
...
<img id="logo-detalle" src="productimages/<?php echo htmlentities($row['']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="productimages/<?php echo htmlentities($row['']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="100" height="100" alt="" title="<?php echo htmlentities($row['productName']);?>">
<p>------------------------------------------------------------------------------------------------------------------------------</p>
</div></div>
<?php   } ?>
	</div>
