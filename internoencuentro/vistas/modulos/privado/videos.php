...
<head>
	...
	<title><?php include('include/titulo.php');?> | Administrar videos</title>
...
?>											
										<tr>
                                            <td>
											<a href="editar-video.php?id=<?php echo $row['id']?>" ><i title="Editar video" class="icon-edit"></i></a>
                                             
											<a href="videos.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Estas seguro que quieres eliminar el video de la base de datos??')"><i title="Eliminar video" class="icon-remove-sign"></i></a></td>
										 
											<td><?php echo htmlentities($row['nombreVideo']);?></td>
