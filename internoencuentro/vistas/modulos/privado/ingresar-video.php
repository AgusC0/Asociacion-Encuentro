...
if(isset($_POST['submit']))
{
	...
	$videonombre=$_POST['nombreVideo'];
	$videoyoutube=$_POST['videoYoutube'];
 
$sql=mysql_query("insert into videos(nombreVideo,videoYoutube) values('$videonombre','$videoyoutube')");
$_SESSION['msg']="Video ingresado exitosamente !!";
...
<head>
	...
	<title><?php include('include/titulo.php');?>  | Agregar Video</title>
...
<label class="control-label" for="basicinput">Titulo/Lugar</label>
<div class="controls">
<input type="text"    name="nombreVideo"  placeholder="Ingresar lugar" class="span8 tip" required>
</div>
</div>
