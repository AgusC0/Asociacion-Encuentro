...
{
$filename        = $_FILES['productimage8']['name'];
$sourceFoto      = $_FILES['productimage8']['tmp_name'];
...
$sql=mysql_query("update noticias set productImage8='$nuevoNameFoto' where id='$pid' ");
$_SESSION['msg']="Imagen 8 actualizada exitosamente!!";
}
?>
<!DOCTYPE html>
<html lang="es">
...
$query=mysql_query("select tituloNoticia,productImage8,id from noticias where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen actual 8</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage8']);?>" width="200" height="100"> 
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen nueva 8</label>
<div class="controls">
<input type="file" name="productimage8" id="productimage8" value="" class="span8 tip" required>
</div>
</div>
