...
<head>
	...
	<title><?php include('include/titulo.php');?> | Administrar Slide Inicio</title>
...
<?php include('include/sidebar.php');?>				
	...
	<div class="module">
							<div class="module-head">
								<h3>Administrar Slide de Imagenes Portada</h3>
							</div>
...
<?php $query=mysql_query("select * from slide ");
$cnt=1;
...
?>											
										<tr>
                                            <td>
											<a href="editar-slide.php?id=<?php echo $row['id']?>" ><i title="Editar slide" class="icon-edit"></i> Cambiar</a>
                                             
									 
										    <td>Imagen <?php echo htmlentities($row['id']);?></td>
											<td>Nº <?php echo htmlentities($row['nroPropiedad']);?></td>
