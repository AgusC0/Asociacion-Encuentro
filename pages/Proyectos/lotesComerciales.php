...
<section class="container mx-auto max-w-7xl px-4 py-16">
  ...
  <div class="grid gap-8 md:grid-cols-3">
    ...
    <div
      data-aos="fade-up" 
      data-aos-duration="<?= 1000 + 600*($d['id']-1) ?>"
      class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden flex flex-col hover:shadow-2xl transition-shadow duration-300"
    >
      <img
      ...
      <div class="p-6 flex flex-col flex-grow">
        <h3 class="text-center text-xl font-bold mt-5"><?= htmlspecialchars($d['title']) ?></h3>
        <div class="border-t border-gray-300 my-3 mx-auto w-12"></div>
        <p class="text-center text-gray-700 dark:text-gray-300 flex-grow" style="height: 7em; overflow: hidden;">
          <?= htmlspecialchars($d['description']) ?>
        </p>
        <a
          href="<?= htmlspecialchars($d['btn_link']) ?>"
          target="_blank"
          class="btn-primary mt-5 block text-center py-3 rounded bg-blue-600 text-white font-semibold hover:bg-blue-700 transition"
        >
...
<section class="container mx-auto max-w-7xl px-4 py-16 grid md:grid-cols-5 gap-8">
  ...
  <!-- Izquierda (40%) -->
  <div class="md:col-span-2 flex flex-col justify-center" data-aos="fade-right" data-aos-duration="1500">
    <h3 class="text-2xl font-bold mb-6">
      Invertir en Puerto Sauce junto a Encuentro Comunitario te brinda seguridad y respaldo
    </h3>
    ...
    <a
      href="https://wa.me/543534195505"
      target="_blank"
      class="btn-primary inline-block px-6 py-3 rounded bg-blue-600 text-white font-semibold hover:bg-blue-700 transition"
    >
  ...
  <!-- Derecha (60%) -->
  <div class="md:col-span-3 grid grid-cols-3 gap-6" data-aos="fade-left" data-aos-duration="1600" >
    <?php foreach($caracteristicas as $c): ?>
    <div class="flex flex-col items-center text-center">
      <img src="<?= htmlspecialchars($c['icon']) ?>" alt="<?= htmlspecialchars($c['alt']) ?>" class="w-24 h-24 mb-2" />
      <p class=".text-negro"><?= htmlspecialchars($c['text']) ?></p>
    </div>
    <?php endforeach; ?>

    <!-- Botón Descargar PDF centrado debajo -->
    <div class="col-span-full text-center mt-6">
      <a
        href="descargas/Puerto-Sauce-Lotes-comerciales.pdf"
        target="_blank"
        class="btn-primary px-8 py-3 rounded bg-blue-600 text-white font-semibold hover:bg-blue-700 transition inline-block"
      >
        Descargar PDF
      </a>
    </div>
...
<section class="w-full mt-5" style="height: 90vh;">
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13472.916800425359!2d-63.2038877!3d-32.4130181!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95cc433ac1ad6bb1%3A0xe9f7d1499f29c855!2sAsociaci%C3%B3n%20Civil%22Encuentro%20Comunitario%22!5e0!3m2!1ses-419!2sar!4v1698210040311!5m2!1ses-419!2sar"
